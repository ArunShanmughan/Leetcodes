...
// You are given an array seats of length n, where seats[i] is the 
// position of the ith seat. You are also given the array students of length n, 
...
var seats = [4,1,5,9], students = [1,3,2,6];
...
let newresult = 0; 
 for(let i=0;i<seats.length;i++) {
     newresult+=Math.abs(seats[i]-students[i]);
 }
 return newresult;
};
